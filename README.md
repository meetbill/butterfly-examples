...
```
$ git clone https://github.com/meetbill/butterfly_handlers.git
$ cd butterfly_handlers
...
* 定期使用项目仓库内容更新自己仓库内容。
```
$ git remote add upstream https://github.com/meetbill/butterfly_handlers.git
$ git fetch upstream
$ git checkout master
